...
void mem_updatemap()
{
	...
	map[0x1] = getRomBank(0);
	map[0x2] = getRomBank(0);
	map[0x3] = getRomBank(0);
	if (mbc.rombank < mbc.romsize)
	{
		map[0x4] = getRomBank(mbc.rombank) - 0x4000;
		map[0x5] = getRomBank(mbc.rombank) - 0x4000;
		map[0x6] = getRomBank(mbc.rombank) - 0x4000;
		map[0x7] = getRomBank(mbc.rombank) - 0x4000;
	}
...
byte mem_read(int a)
{
	...
	case 0x0:
	case 0x2:
		return getRomBank(0)[a& 0x3FFF];
	case 0x4:
	case 0x6:
		return getRomBank(mbc.rombank)[a & 0x3FFF];
	case 0x8:
